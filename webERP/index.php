				...
				<table width="100%">
					...
					<td class="menu_group_items">  <!-- PO Inquiries -->
						<table width="100%" class="table_index">
							...
							<tr>
							<td class='menu_group_item'>
								<?php echo "<A HREF='" . $rootpath . '/OutstandingPOrders.php?' . SID . "'><LI>" . _('Outstanding Purchase Orders') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
				...
				<table width="100%">
					...
					<td class="menu_group_items">
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/StockIssues.php?' . SID . "'><LI>" . _('Inventory Issues') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
					...
					<td class="menu_group_items">
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/SuggestedOrders.php?' . SID . "'><LI>" . _('List Suggested Orders') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
				...
				<table width="100%">		<!-- Gereral Ledger Option Headings-->
					...
					<td class="menu_group_items">  <!-- Gereral inquiry options -->
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . "/GLProfit_Loss.php?" . SID . "'><LI>" . _('Income and Expenditure Statement') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/CashFlow.php?' . SID . "'><LI>" . _('Cash Flow') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
